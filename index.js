...
async function startXeonBotInc() {
    ...
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['GɪɴGᴇʀBᴏᴛMD','Safari','1.0.0'],
        auth: state,
        version
    })
    ...
    XeonBotInc.sendMessage(`254792893310@s.whatsapp.net`, {text: `*Report Bot:* Someone Called Bot`})
    await sleep(8000)
